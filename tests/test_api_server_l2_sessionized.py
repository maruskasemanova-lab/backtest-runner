...
def test_normalize_l2_feature_map_for_market_day_sessions_resets_day_scoped_fields() -> (
    None
):
    ...
    feature_map = {
        k1: {
            "l2_delta": 2.0,
            "l2_cumulative_delta": 102.0,
            "l2_delta_acceleration": 99.0,
            "l2_book_pressure": 0.10,
            "l2_book_pressure_change": 5.0,
        },
        k2: {
            "l2_delta": -1.0,
            "l2_cumulative_delta": 101.0,
            "l2_delta_acceleration": -77.0,
            "l2_book_pressure": 0.30,
            "l2_book_pressure_change": -3.0,
        },
        k3: {
            "l2_delta": 5.0,
            "l2_cumulative_delta": 205.0,
            "l2_delta_acceleration": 44.0,
            "l2_book_pressure": -0.20,
            "l2_book_pressure_change": 4.0,
        },
        k4: {
            "l2_delta": 1.0,
            "l2_cumulative_delta": 206.0,
            "l2_delta_acceleration": -11.0,
            "l2_book_pressure": 0.10,
            "l2_book_pressure_change": -2.0,
        },
    }
    bars = [
        {"timestamp": ts_1},
    ...
    stats = api_server._normalize_l2_feature_map_for_market_day_sessions(
        feature_map, bars
    )
...
def test_normalize_l2_feature_map_for_market_day_sessions_ignores_missing_minutes() -> (
    None
):
    ts_1 = "2026-01-20T14:30:00+00:00"
