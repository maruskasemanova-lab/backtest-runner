...
run_requests_path = REPO_ROOT / "src" / "models" / "run_requests.py"
with run_requests_path.open("r", encoding="utf-8") as f:
    text = f.read()
...
with run_requests_path.open("w", encoding="utf-8") as f:
    f.write(text)

# 2. Update start_run_execution_config_service.py
service_path = REPO_ROOT / "src" / "services" / "start_run_execution_config_service.py"
